Аудіомод для відтворення FLAC без переривань
Працює з ESP32 та ESP32S3 ядрами 3.3.5
----

Для використання в Arduino 1.8.19 з ядром 3.3.5 потрібно замінити два файли
...
C:\Users\User\AppData\Local\Arduino15\packages\esp32\tools\esp32s3-libs\3.3.5\lib
...
..esp32\liblwip.a 
та замінити ними файли в директорії: 
C:\Users\User\AppData\Local\Arduino15\packages\esp32\tools\esp32-libs\3.3.5\lib
----
